...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bid.auto_bid_queue_num'
        db.add_column(u'auction_bid', 'auto_bid_queue_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bid.auto_bid_queue_num'
        db.delete_column(u'auction_bid', 'auto_bid_queue_num')
