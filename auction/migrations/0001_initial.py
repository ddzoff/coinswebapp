...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Auctions'
        db.create_table(u'auction_auctions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('min_bid', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('start_price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'auction', ['Auctions'])

        # Adding model 'Bid'
        db.create_table(u'auction_bid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('auctions', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auction.Auctions'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('bid_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'auction', ['Bid'])


    def backwards(self, orm):
        # Deleting model 'Auctions'
        db.delete_table(u'auction_auctions')

        # Deleting model 'Bid'
        db.delete_table(u'auction_bid')
