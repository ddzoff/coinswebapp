...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auctions.current_bid'
        db.add_column(u'auction_auctions', 'current_bid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auctions.current_bid'
        db.delete_column(u'auction_auctions', 'current_bid')
